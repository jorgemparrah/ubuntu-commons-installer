#!/usr/bin/env bash
# tests/test_ranger_installer.sh
#
# Prueba simulada (mocks) de scripts/system/install_ranger.sh (Hito 11,
# Fase 2). No instala nada real: apt-get/apt/dpkg/sudo se interceptan con
# comandos falsos en un PATH temporal.
#
# Uso:
#   bash tests/test_ranger_installer.sh
set -Eeuo pipefail
...
INSTALL_SH="${UCI_REPO_ROOT}/scripts/system/install_ranger.sh"
readonly INSTALL_SH
readonly UCI_BIN_NAME="ranger"
readonly UCI_PKG_NAME="ranger"
