...
UCI_GITKRAKEN_SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
# shellcheck source=../lib/snap.sh
source "${UCI_GITKRAKEN_SCRIPT_DIR}/../lib/snap.sh"
# shellcheck source=../lib/installer_cli.sh
source "${UCI_GITKRAKEN_SCRIPT_DIR}/../lib/installer_cli.sh"

TOOL_NAME="GitKraken"
SNAP_PACKAGE="gitkraken"
