...
#
# Instalador individual del paquete "v4l-utils" (ver ADR 0031,
...
UCI_V4L_UTILS_SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
# shellcheck source=../lib/apt.sh
source "${UCI_V4L_UTILS_SCRIPT_DIR}/../lib/apt.sh"
# shellcheck source=../lib/installer_cli.sh
source "${UCI_V4L_UTILS_SCRIPT_DIR}/../lib/installer_cli.sh"
