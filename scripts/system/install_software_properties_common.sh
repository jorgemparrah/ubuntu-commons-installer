#!/usr/bin/env bash
# install_software_properties_common.sh
#
# Instalador individual del paquete "software-properties-common" (ver ADR 0031,
...
UCI_SOFTWARE_PROPERTIES_COMMON_SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
# shellcheck source=../lib/apt.sh
source "${UCI_SOFTWARE_PROPERTIES_COMMON_SCRIPT_DIR}/../lib/apt.sh"
# shellcheck source=../lib/installer_cli.sh
source "${UCI_SOFTWARE_PROPERTIES_COMMON_SCRIPT_DIR}/../lib/installer_cli.sh"
