...
# install_vlc.sh
#
# Instalador individual del paquete "vlc" (ver ADR 0031,
...
UCI_VLC_SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
# shellcheck source=../lib/apt.sh
source "${UCI_VLC_SCRIPT_DIR}/../lib/apt.sh"
# shellcheck source=../lib/installer_cli.sh
source "${UCI_VLC_SCRIPT_DIR}/../lib/installer_cli.sh"
