...
# install_xeyes.sh
#
# Instalador nuevo (Hito 47, ver docs/ROADMAP.md): agrega xeyes al
...
# se llama `x11-apps` (paquete meta con varias utilidades X11 clásicas,
# no solo xeyes), confirmado con `dpkg -L x11-apps` que instala el
# binario `xeyes` en `/usr/bin`.
