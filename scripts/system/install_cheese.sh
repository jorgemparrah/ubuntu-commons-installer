...
# install_cheese.sh
#
# Instalador individual del paquete "cheese" (ver ADR 0031,
...
UCI_CHEESE_SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
# shellcheck source=../lib/apt.sh
source "${UCI_CHEESE_SCRIPT_DIR}/../lib/apt.sh"
# shellcheck source=../lib/installer_cli.sh
source "${UCI_CHEESE_SCRIPT_DIR}/../lib/installer_cli.sh"
