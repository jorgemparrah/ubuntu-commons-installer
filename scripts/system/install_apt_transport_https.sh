#!/usr/bin/env bash
# install_apt_transport_https.sh
#
# Instalador individual del paquete "apt-transport-https" (ver ADR 0031,
...
UCI_APT_TRANSPORT_HTTPS_SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
# shellcheck source=../lib/apt.sh
source "${UCI_APT_TRANSPORT_HTTPS_SCRIPT_DIR}/../lib/apt.sh"
# shellcheck source=../lib/installer_cli.sh
source "${UCI_APT_TRANSPORT_HTTPS_SCRIPT_DIR}/../lib/installer_cli.sh"
