...
# install_gparted.sh
#
# Instalador individual del paquete "gparted" (ver ADR 0031,
# docs/adr/0031-separar-instaladores-multi-paquete-en-agrupador-mas-individuales.md).
# Antes bandeado dentro del instalador multi-paquete de "System Utilities".
# Usa el dispatcher y los helpers APT compartidos, mismo patrón que
# scripts/system/install_ranger.sh.

set -Eeuo pipefail

UCI_GPARTED_SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
# shellcheck source=../lib/apt.sh
source "${UCI_GPARTED_SCRIPT_DIR}/../lib/apt.sh"
# shellcheck source=../lib/installer_cli.sh
source "${UCI_GPARTED_SCRIPT_DIR}/../lib/installer_cli.sh"
