...
# funcionales relevantes más allá del nombre de paquete/binario. Ranger no
# tiene archivo de configuración propio gestionado por este proyecto, ni
# servicio de sistema, ni GUI — mismo perfil de riesgo que cmatrix.
#
...
#               nunca toca configuración personal del usuario, Ranger no
#               gestiona ninguna a través de este proyecto.
...
#               necesario para un paquete sin estado propio que perder.
...
UCI_RANGER_SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
# shellcheck source=../lib/apt.sh
source "${UCI_RANGER_SCRIPT_DIR}/../lib/apt.sh"
# shellcheck source=../lib/installer_cli.sh
source "${UCI_RANGER_SCRIPT_DIR}/../lib/installer_cli.sh"
