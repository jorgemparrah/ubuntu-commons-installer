...
# install_figlet.sh
#
# Instalador nuevo (Hito 47, ver docs/ROADMAP.md): agrega figlet al
# catálogo (category=system, subcategory=extras, mismo grupo que
# cmatrix). Usa el dispatcher y los helpers APT compartidos, mismo
# patrón apt-simple que install_httpie.sh. Paquete y binario coinciden con la herramienta (`figlet`), sin ninguna particularidad.
