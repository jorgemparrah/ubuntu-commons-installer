...
# install_wget.sh
#
# Instalador individual del paquete "wget" (ver ADR 0031,
...
UCI_WGET_SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
# shellcheck source=../lib/apt.sh
source "${UCI_WGET_SCRIPT_DIR}/../lib/apt.sh"
# shellcheck source=../lib/installer_cli.sh
source "${UCI_WGET_SCRIPT_DIR}/../lib/installer_cli.sh"
